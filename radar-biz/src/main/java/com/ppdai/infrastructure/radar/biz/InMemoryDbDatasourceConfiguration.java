...
public class InMemoryDbDatasourceConfiguration {
    ...
    @Primary
    public SqlSessionFactory sqlSessionFactory(@Qualifier("inMemoryDbDataSource") DataSource dataSource) throws Exception {
...
//        return dataSource;
    	return new EmbeddedDatabaseBuilder().setType(EmbeddedDatabaseType.H2)
                .addScript("classpath:testsql/schema.sql").build();
    }
